...
class TestFlightUpdate(unittest.TestCase):
    ...
    @patch("builtins.open", new_callable=mock_open, read_data="line0\n/flights-dir\nline2\n/archive\nline4\n")
    @patch.dict(os.environ, {"CONFIG_FILE": "dummy_config"})  # Set the CONFIG_FILE env variable
    ...
    def test_move_old_files_delete_mode(self):
        ...
        expected = [
            f"rm /flights-dir/test.json",
            f"rm /flights-dir/file2.json"
        ]
