...
@click.option('--add_mode', default="y", type=str, help='Set mode to just flights', prompt='Set mode to add flights (y/n)')
@click.option('--update_mode', default="n", type=str, help='Name of script in updates/ to use', prompt='Name of script to update')
@click.option('--update_id', default="n", type=str, help='New elasticsearch index to move to', prompt='Flight id to update')
